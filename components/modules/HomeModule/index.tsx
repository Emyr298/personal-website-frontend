          ...
          return {
            ...
            positions: curExperience.positions.map((position) => {
              return {
                ...
                endDate: !position.end_date ? null : new Date(position.end_date),
              };
            }),
          };
        }),
  ...
  if (loading) {
    return (
      <div className='w-screen h-screen flex justify-center items-center'>
        <svg className="w-8 h-8 mr-2 text-gray-500 animate-spin dark:text-gray-500 fill-green-300" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
